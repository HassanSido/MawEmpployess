...
<template>
    ...
    <div class="sidenav">
        ...
        <hr>
        <a href="/day" class="">day information</a>
        <hr>
        <a href="/daily" class="active">daily database</a>
        <hr>
            ...
            <div>
                <div v-for=" (Work,index) of DaysTable" :key="Work">
                    ...
                    <table id="" class="table table-striped table-bordered mt-4" role="grid"
                        ...
                        <tbody>
                            <tr v-for="day of Work" :key="day">
                                <td>{{ day['id'] }}</td>
                                <td>{{day['Name']}}</td>
                                <td>{{day['day']}}</td>
                                <td v-if="day['Time'] == 1">Morning</td>
                                <td v-if="day['Time'] == 0">Nite</td>
                                <td>{{ day['place'] }}</td>
                                <td>{{ day['price'] }}</td>
                                <td v-if="day['System'] == 1">Monthly</td>
                                <td v-if="day['System'] == 0">Daliy</td>
                                <td></td>
                                <td>{{ day['Note'] }}</td>
                            </tr>
                        </tbody>
